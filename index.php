<?php
    ...
    $db = new Database;
    $con = $db->conectar();
    $consulta = $con->query("SELECT id, producto, precio, estado, recomendacion FROM primos");
    $consulta->execute();
...
<header class="container-hero">
    ...
    <div class="container-navbar">
        ...
        <main Class="container">
            <h1>Ciber-seguridad(servicios)</h1>
            <div class="row">
                <div class="col">
                    <h4>CRUD-Productos</h4>
                    <button><a href="nuevo.php" class="btn btn primary float-right">Nuevo</a></button>
                </div>
            </div> 
            <div class="row">
                <div class="col">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="w.html"class="btn btn-warning">Comprar</a></td>
                                </tr>
                            <?php } ?>
                        </tbody> 
                    </table>
        ...
        <div class="container container-footer">
            ...
            <div class="copyright">
            <p>Desarrollado por Security Suport &copy; 2024</p>
